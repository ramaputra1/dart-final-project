...
// our base class that other can extend
...
// will represent command-line options like --verbose or --output=file.txt
class Option extends Argument { // The extends keyword establishes the inheritance relationship.
  Option(
    this.name, {
    required this.type,
    this.help,
